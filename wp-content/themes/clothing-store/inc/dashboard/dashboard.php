...
function clothing_store_guide() {
	...
	<div class="wrap getting-started">
		<div class="container">
			...
			<div class="col-md-3">
				<h3><?php esc_html_e('Premium Clothing Store Theme','clothing-store'); ?></h3>
				<img class="clothing_store_img_responsive" style="width: 100%;" src="<?php echo esc_url( get_template_directory_uri() ); ?>/screenshot.png">
				<div class="pro-links">
					<hr>
